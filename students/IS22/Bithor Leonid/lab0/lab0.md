...
Перешел по ссылке на репозиторий text-generation-webui на GitHub.
Скопировал адрес репозитория и создал папку на своем компьютере для установки.
Клонировал репозиторий с помощью команды:
git clone https://github.com/oobabooga/text-generation-webui
1

Перешел в директорию репозитория:
cd text-generation-webui
3

Создал виртуальную среду и активировал её (для Windows):
python -m venv venv
